...
// Re-initialize when variant changes (gallery might be rebuilt). Skip
// quick-view changes — they don't touch the main page's lightbox gallery.
window.addEventListener("product:variant-changed", (event) => {
